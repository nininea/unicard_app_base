...
namespace Android.Gms.Maps.Utils {
	...
	public sealed partial class BuildConfig : global::Java.Lang.Object {
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.google.maps.android']/class[@name='BuildConfig']/field[@name='DEBUG']"
		[Register ("DEBUG")]
		public const bool Debug = (bool) false;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.google.maps.android']/class[@name='BuildConfig']/field[@name='FLAVOR']"
		[Register ("FLAVOR")]
		public const string Flavor = (string) "";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.google.maps.android']/class[@name='BuildConfig']/field[@name='PACKAGE_NAME']"
		[Register ("PACKAGE_NAME")]
		public const string PackageName = (string) "com.google.maps.android";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.google.maps.android']/class[@name='BuildConfig']/field[@name='VERSION_CODE']"
